...
import imgB from '../assets/sampleBackground10.jpg';
...
<View style={styles.mainContainer}>
    ...
    <View style = {styles.logoContainerb}>
    <Image source={{uri: 'https://i.ya-webdesign.com/images/cherries-clipart.png'}} style={styles.logob}/>
    </View>
    </View>
</ImageBackground>
)
